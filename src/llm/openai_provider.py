...
class OpenAIProvider:
    def __init__(self, api_key: str | None = None, base_url: str | None = None, config: Any | None = None) -> None:
        cfg = config or DEFAULT_CONFIG
        self.client = OpenAI(
            api_key=api_key or cfg.opencode_zen_api_key,
            base_url=base_url or cfg.opencode_zen_base_url,
