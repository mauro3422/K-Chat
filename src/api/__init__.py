...
Nuevo código debería importar desde `src.api.<dominio>` directamente.
Este módulo queda como superficie de transición para callers antiguos.
"""
...
from src.api.chat import get_default_model, chat_stream, auto_rename_session
...
__all__ = [
    ...
    "save_widget_state", "get_widget_states", "db_save_widget",
    "db_get_widget", "db_get_widget_versions", "db_get_widget_by_version",
    "get_default_model", "chat_stream", "auto_rename_session",
