    ...
    "AGENTS.md": dedent("""\
        ...
        - **Meta-Tool System — execute_action**:
          ...
          * Actions (`action_name`) and arguments (`arguments`) available:
            - `web_search`: Search the web. Arguments: `query` (string, required), `max_results` (int, optional, default 3), `categories` (string, optional), `language` (string, optional), `time_range` (string, optional), `page` (int, optional, default 1), `safe_search` (int, optional). Usage: `execute_action(action_name="web_search", arguments={"query": "...", "categories": "news", "max_results": 5})`
            - `fetch_url`: Fetch and read a full web page. Arguments: `url` (string, required), `max_chars` (int, optional, default 10000, max 50000). Usage: `execute_action(action_name="fetch_url", arguments={"url": "https://example.com/article"})`
