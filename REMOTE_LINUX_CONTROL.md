...
sudo systemctl status kairos --no-pager
...
En actualizaciones posteriores, `git pull` solo no alcanza porque hay que compilar y reiniciar. Usar `./scripts/kairos-node.sh update`.
