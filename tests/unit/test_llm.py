...
def test_fallback_switch_updates_system_prompt():
    ...
    with patch("src.llm.models._provider.chat") as mock_chat, \
         patch("src.llm.models._provider.list_models", return_value=[mock_model_1, mock_model_2]):
        ...
        assert mock_chat.call_args_list[0].kwargs.get("model") == "big-pickle"
        assert mock_chat.call_args_list[2].kwargs.get("model") == "deepseek-v4-flash-free"
        ...
        assert mock_chat.call_args.kwargs.get("model") == "deepseek-v4-flash-free"
